...
void I_FinishUpdate (void)
{
	...
	while (y--)
	{
	    ...
	    {
		fouripixels = *ilineptr++;
		fouropixels[0] = 0x01010101 * (fouripixels >> 24);
                fouropixels[1] = 0x01010101 * ((fouripixels >> 16) & 0xff);
		fouropixels[2] = 0x01010101 * ((fouripixels >> 8) & 0xff);
		fouropixels[3] = 0x01010101 * (fouripixels & 0xff);
